<template>
    <div class="basic_parent_div_">
        <div v-if="currentStep === 0" class="basic_child_msg_ flex flex-col gap-4 items-center justify-start p-4">
            <span>
                <svg width="200px" height="200px" viewBox="-20 0 190 190" fill="none"
            ...
            <p class="child_msg_">
                It appears that you haven't registered an account on Decast yet. No problem! You can easily create one
                on the <a href="https://decast.live" target="_blank" class="text-blue-500">Decast.live</a> website. Once
                done, return to this extension to activate it. If you require any assistance, simply click 'Next' for
        ...
        <div class="flex w-full justify-end items-center mt-4 gap-4">
            <button class="nxt_btn_ px-2 text-lg" @click="prevInstructions"
