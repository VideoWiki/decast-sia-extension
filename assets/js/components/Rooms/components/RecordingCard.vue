    ...
    <div class="recordings flex flex-col justify-between items-center mb-4 w-full py-2 px-4 gap-2">
        <div class="flex flex-row justify-between items-center w-full">
            ...
            <div class="flex gap-3 justify-end items-center">
                <span class="edit_btn cursor-pointer" @click="editRecord">
                ...
                <span class="copy_btn cursor-pointer" @click="copyRecording">
                ...
                <span class="open_btn cursor-pointer" @click="openRecording">
